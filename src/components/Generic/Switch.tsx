  ...
  return <>
    <input
      className={
        ...
        after:rounded-full after:border-none after:shadow-[0_0px_3px_0_rgb(0_0_0_/_7%),_0_2px_2px_0_rgb(0_0_0_/_4%)]
        ...
        checked:after:content-[''] hover:cursor-pointer focus:outline-none focus:ring-0 
        ...
        bg-neutral-300
        ${state?'after:bg-neutral-500':'after:bg-neutral-400'}
        `
      }
      type="checkbox"
      role="switch"
